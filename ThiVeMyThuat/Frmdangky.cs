...
namespace ThiVeMyThuat
{
    public partial class Frmdangky : Form
    {
        ...
        private void loadgrv()
        {
            ...
            //dgv_thisinh.Columns[0].HeaderText = "STT";
            //dgv_thisinh.Columns[1].HeaderText = "Số HS";
            //dgv_thisinh.Columns[2].HeaderText = "Họ và tên";
            //dgv_thisinh.Columns[3].HeaderText = "Giới tính";
            //dgv_thisinh.Columns[4].HeaderText = "Ngày sinh";
            //dgv_thisinh.Columns[5].HeaderText = "Nơi Sinh";
            //dgv_thisinh.Columns[6].HeaderText = "Số CMND";
            //dgv_thisinh.Columns[7].HeaderText = "Ngày cấp CMND";
            //dgv_thisinh.Columns[8].HeaderText = "Nơi cấp CMND";
            //dgv_thisinh.Columns[9].HeaderText = "Hộ khẩu thường trú";
            //dgv_thisinh.Columns[10].HeaderText = "Số điện thoại";
            //dgv_thisinh.Columns[11].HeaderText = "Điện thoại cố định";
            //dgv_thisinh.Columns[12].HeaderText = "Email";
            //dgv_thisinh.Columns[13].HeaderText = "Năm tốt nghiệp";
            //dgv_thisinh.Columns[14].HeaderText = "Lệ phí";
        ...
        private void Frmdangky_Load(object sender, EventArgs e)
        {
            ...
            loadgrv();
          // dgv_thisinh.CurrentCell = dgv_thisinh
            for (int i = 0; i < dgv_thisinh.Rows.Count; i++)
            {
                if (dgv_thisinh.Rows[i].Cells[1].Value != null)//Nếu ô thứ i của cột thứ 1 (cột sau cột STT ấy) mà có dữ liệu thì gán giá trị cho cột STT, nếu không thì cột STT cũng không có dữ liệu lun
                {
                    dgv_thisinh.Rows[i].Cells[0].Value = i + 1;
                }
            }
        }
